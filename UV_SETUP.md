...
screen -S cursor-agent -X stuff "cd /share/datasets/home/wendler/code/mcp-telegram && uv run python agent_vibe.py -w /share/datasets/home/wendler/code -d YOUR_GROUP_ID -i 5\r"
```
